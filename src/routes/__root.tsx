...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MyLedger — Personal Finance Tracker" },
      {
        name: "description",
        content:
          "Track bank accounts, credit cards, EMIs and daily spending on your phone, with instant sync across devices.",
      },
      { property: "og:title", content: "MyLedger — Personal Finance Tracker" },
      {
